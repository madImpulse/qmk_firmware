...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_promenade_grid_wrapper(
        _______,  MADROW12345LOW,                                  _______, _______,  MADROW67890LOW,                                   _______,
        _______,  MADROWQWERTLOW,                                  _______, _______, MADROWYUIOPLOW,                                   _______,
    ...
    [_RAISE] = LAYOUT_promenade_grid_wrapper(
        _______,  MADROW12345RAI,                                  _______, _______,  MADROW67890RAI,                                   _______,
    ...
    [_ADJUST] = LAYOUT_all(
        ...
        _______, KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______, KC_MPLY, KC_MSTP, _______, _______, _______, _______, KC_PSCR, _______,
